...
/// <summary>
/// Reads the live process list through System.Diagnostics. Stateless, so one instance serves the
/// whole process; every call is a fresh snapshot.
/// </summary>
/// <remarks>
...
public sealed class ProcessFinder : IProcessFinder
{
    ...
    public IReadOnlyList<ProcessInfo> ListAll()
    {
    ...
    public ProcessInfo? FindById(uint pid)
    {
        try
        {
