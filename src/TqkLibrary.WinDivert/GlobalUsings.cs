// Types are organised by kind into per-feature sub-namespaces (.Interfaces / .Enums / .Models);
// these global usings re-export them so the rest of the assembly can reference them unqualified.
