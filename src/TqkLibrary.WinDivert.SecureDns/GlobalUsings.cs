...
// Core types this assembly builds on. Global usings do not cross an assembly boundary, so each
// project re-declares the ones it uses throughout.
...
global using TqkLibrary.WinDivert.Native.Interfaces;
global using TqkLibrary.WinDivert.Native.Models;
global using TqkLibrary.WinDivert.Packet.Enums;
global using TqkLibrary.WinDivert.Packet.Interfaces;
global using TqkLibrary.WinDivert.Packet.Models;
global using TqkLibrary.WinDivert.Pipeline;
